...
# OBJECTIVES:
1. To enable users to ask natural language questions and convert them into SQL queries on Delta tables.
2. To enable users, interact with dashboards using chat commands
3. To generate narrative summaries of KPIs
4. To generate predictive responses Predictive/what-if analysis
5. To Implement validation while answering BI queries, LLM enforcing governance

# SOLUTION ARCHITECTURE:
<img width="750" height="450" alt="image" src="https://github.com/user-attachments/assets/5f67cf6f-51bc-40f6-9ffa-06b2f4a2bcdf" />

## Data Type: Apple Retail and sales data – 1M+ Rows
<img width="450" height="325" alt="image" src="https://github.com/user-attachments/assets/7cc95027-690b-47f1-b89a-37c7c5090437" />
